# 第12节:命名空间
上一节我们讲解了php当中魔术常量的定义和使用方式，本节我们来学习php当中命名空间的定义以及使用方法，命名空间中的动态访问特征

### 一、学习目标
命名空间可以解决什么问题，如何定义命名空间的方法及命名空间的引用方式，命名空间之外的代码如何将数据转换到空间内部，怎么动态访问命名空间之内的内容
